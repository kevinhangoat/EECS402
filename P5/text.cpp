...
int SimulatorClass::carArrival(int &carTime)
{
    ...
    int numRiders = lineSTD.getNumElems() +
                    lineSFP.getNumElems() +
                    lineFP.getNumElems();
    ...
    {
        spaceLeft--;
        numLoadedFromSTDLine += 1;
        stdSize--;
        stdTotalWaitTime += (carTime - riderToBoard);
        carIsFilled = checkNumSeats(spaceLeft);
    }

    cout << "Statistics show that in this ride:" << endl;
    cout << "Type of lines             " << "||   SFP   ||"
                                              << "   F P   ||"
                                              << "   STD   ||" << endl;
    cout << "Number of people boarded  "
         << "||    " <<numLoadedFromSFPLine << "    ||"
         << "    " <<numLoadedFromFPLine << "    ||"
         << "    " <<numLoadedFromSTDLine << "    ||" << endl;
...
void SimulatorClass::performStatistics()
{
    ...
    cout << "SFP Line:" << "       " << sfpAvgWaitTime << endl;

    cout << "Maximum size of each line:" << endl;
    cout << "Standard Line:" << "  " << stdMax << endl;
    cout << "FP Line:" << "        " << fpMax << endl;
    cout << "SFP Line:" << "       " << sfpMax << endl;
}
...
{
    cout << "Statistics show that:" << endl;
    cout << "Type of lines             " << "||   SFP   ||"
                                          << "   F P   ||"
                                          << "   STD   ||" << endl;
    cout << "Number of people waiting  "
         << "||    " << sfpSize << "    ||"
         << "    " << fpSize << "    ||"
         << "    " << stdSize << "    ||" << endl;
}
